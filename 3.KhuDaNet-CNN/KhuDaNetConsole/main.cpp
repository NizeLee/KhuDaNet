...
int main(int argc, char* argv[])
{
	...
	gNetwork.AddLayer(CKhuDaNetLayerOption(KDN_LT_INPUT | KDN_LT_IMG, 1, 0, 32, 32, 0, 0, 0.15));
	gNetwork.AddLayer(CKhuDaNetLayerOption(KDN_LT_CON, 6, 0, 28, 28, 5, KDN_AF_RELU, 0.15));
	gNetwork.AddLayer(CKhuDaNetLayerOption(KDN_LT_POOL, 6, 0, 14, 14, 2, 0, 0.5));
	gNetwork.AddLayer(CKhuDaNetLayerOption(KDN_LT_CON, 16, 0, 10, 10, 5, KDN_AF_RELU, 0.15));
	gNetwork.AddLayer(CKhuDaNetLayerOption(KDN_LT_POOL, 16, 0, 5, 5, 2, 0, 0.5));
	gNetwork.AddLayer(CKhuDaNetLayerOption(KDN_LT_CON, 120, 0, 1, 1, 5, KDN_AF_RELU, 0.15));
	gNetwork.AddLayer(CKhuDaNetLayerOption(KDN_LT_FC, 0, 84, 0, 0, 0, KDN_AF_RELU, 0.15));
